...
export const metadata: Metadata = {
  ...
  keywords: ['built environment', 'strategy', 'design advisory', 'smart cities', 'architecture', 'urban development', 'Africa', 'GCC', 'Dubai', 'Harla Design'],
  ...
  openGraph: {
    ...
    description: 'An advisory focused on strategy, design, delivery and user experience — operating across Africa and the GCC.',
    images: [{ url: '/images/logos/logo-dark.png', width: 1200, height: 630, alt: 'Harla Design' }],
  },
  twitter: {
